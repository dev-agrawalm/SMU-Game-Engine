...
#if _DEBUG
	#define ENGINE_ENABLE_DEBUG_RENDERER  // if uncommented - it will enable debugging features for the renderer
#endif

#define ENABLE_ON_SCREEN_DEBUGGING // if uncommented - it will enable debug rendering for the game
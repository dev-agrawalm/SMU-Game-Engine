...
void App::InitialiseEngineSystems()
{
	...
	uiSystemConfig.m_renderer = g_theRenderer;
	uiSystemConfig.m_window = g_window;
...
void App::Render() const
{
	...
	debugScreenCamera.SetOrthoView(0.0f, 0.0f, consoleCameraOrthoX, consoleCameraOrthoY);

...
void Entity::DebugRender() const
{
	...
	DrawLine(m_position, m_position + m_velocity, DEBUG_LINE_WIDTH, VELOCITY_LINE_COLOR);
	//draw physics circle
	...
	//draw +x basis
	DrawLine(m_position, m_position + GetForwardNormal() * 1.5f, DEBUG_LINE_WIDTH, X_BASIS_COLOR);
	//draw +y basis
	DrawLine(m_position, m_position + GetForwardNormal().GetRotated90Degrees() * 1.5f, DEBUG_LINE_WIDTH, Y_BASIS_COLOR);
}

...
#define Function_ConvertDegreesToRadians	DegreesToRadian
#define Function_ConvertRadiansToDegrees	RadianToDegrees
...
#define Function_DoDiscsOverlap				DoDiscsOverlap2D
...
#define Rng_GetRandomIntLessThan			GetRandomIntLessThan
#define Rng_GetRandomIntInRange				GetRandomIntInRange
#define Rng_GetRandomFloatZeroToOne			GetRandomFloatZeroToOne
#define Rng_GetRandomFloatInRange			GetRandomFloatInRange

#define Function_TransformPosition2D		TransformPos2D
#define Function_TransformPositionXY3D		TransformPosXY3D

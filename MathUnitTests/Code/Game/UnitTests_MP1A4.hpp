...
#define Function_GetNearestPointOnDisc2D	GetNearestPointOnDisk2D
#define Function_PushDiscOutOfPoint2D		PushDiskOutOfPoint2D
#define Function_PushDiscOutOfDisc2D		PushDiskOutOfDisk2D
#define Function_PushDiscsOutOfEachOther2D	PushDisksOutOfEachOther2D
#define Function_PushDiscOutOfAABB2D		PushDiskOutOfAABB2D
...
#define Function_GetTaxicabDistance2D		GetTaxiCabLength2D
...
#define Function_TransformPosition2D_IJ		TransformPos2D
#define Function_TransformPositionXY3D_IJ	TransformPosXY3D

...
#include "Game/UnitTests_MP1A6.hpp" // Uses any or all #defines and dependencies from prior tests
...
#define Function_NormalizeByte						ByteToFloatNormalised
#define Function_DenormalizeByte					FloatToByte

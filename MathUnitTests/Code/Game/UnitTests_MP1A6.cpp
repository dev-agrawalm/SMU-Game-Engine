...
// UnitTests_MP1A6.cpp
//
#include "Game/UnitTests_MP1A6.hpp"
#include <stdio.h>
#include <stdlib.h>
...
#if defined( ENABLE_TestSet_MP1A6_MatrixConstruction ) // Suppress these until Vec4 & Mat44 exist
//-----------------------------------------------------------------------------------------------
...
#endif // ENABLE_TestSet_MP1A6_MatrixConstruction
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A6_MatrixConstruction()
{
#if defined( ENABLE_TestSet_MP1A6_MatrixConstruction )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A6_MatrixStaticCreates()
{
#if defined( ENABLE_TestSet_MP1A6_MatrixStaticCreates )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A6_MatrixAccessors()
{
#if defined( ENABLE_TestSet_MP1A6_MatrixAccessors )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A6_MatrixMutators()
{
#if defined( ENABLE_TestSet_MP1A6_MatrixMutators )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A6_MatrixAppends()
{
#if defined( ENABLE_TestSet_MP1A6_MatrixAppends )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A6_MatrixTransforms()
{
#if defined( ENABLE_TestSet_MP1A6_MatrixTransforms )
...
void RunTests_MP1A6()
{
	printf( "(no unit tests for MP1-A5)\n" );
	printf( "Running tests for MP1-A6 (version 1)...\n" );
	RunTestSet( true, TestSet_MP1A6_MatrixConstruction,		"MP1-A6: Matrix44 Construction" );
	RunTestSet( true, TestSet_MP1A6_MatrixStaticCreates,	"MP1-A6: Matrix44 Static Create methods" );
	RunTestSet( true, TestSet_MP1A6_MatrixAccessors,		"MP1-A6: Matrix44 Accessors (gets)" );
	RunTestSet( true, TestSet_MP1A6_MatrixMutators,			"MP1-A6: Matrix44 Mutators (sets)" );
	RunTestSet( true, TestSet_MP1A6_MatrixAppends,			"MP1-A6: Matrix44 Appends (self-transforms)" );
	RunTestSet( true, TestSet_MP1A6_MatrixTransforms,		"MP1-A6: Matrix44 Transform methods" );
}
